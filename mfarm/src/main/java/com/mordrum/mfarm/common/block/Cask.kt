...
import com.mordrum.mfarm.client.renderers.CaskRenderer
...
class Cask : MalisisBlock(Material.IRON), ITileEntityProvider {
    ...
    override fun getPickBlock(state: IBlockState?, target: RayTraceResult?, world: World?, pos: BlockPos?, player: EntityPlayer?): ItemStack {
        ...
        MBlockState.toNBT(tagCompound, tileEntity.ringsState, "rings_block", "rings_meta")
        MBlockState.toNBT(tagCompound, tileEntity.barrelState, "barrel_block", "barrel_meta")
        MBlockState.toNBT(tagCompound, tileEntity.feetState, "feet_block", "feet_meta")
        tagCompound.setString("cask_state", tileEntity.state.toString())
